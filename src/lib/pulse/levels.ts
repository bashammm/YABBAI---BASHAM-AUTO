...
export const LEVELS: Level[] = [
  {
    ...
    wave: 'triangle',
    scaleName: 'minPent',
    scale: SCALES['minPent']!,
    root: 57,
    difficulty: 'WARMUP',
    stars: 1,
    base: 40,
    density: 'quarter',
    tagline: 'Initial system diagnostics. Calibrate your synaptic reflexes.',
  },
  {
    id: 1,
    name: 'NEON DRIFT',
    ...
    base: 70,
    density: 'eighth',
    tagline: 'Sub-bass cadence along the high-frequency pipeline.',
  },
  {
    id: 2,
    name: 'GRID SURGE',
    ...
    base: 110,
    density: 'e+sync',
    tagline: 'Syncopated lead triggers. Unlock high-yield automation multipliers.',
  },
  {
    id: 3,
    name: 'OVERCLOCK',
    ...
    base: 155,
    density: '16th',
    tagline: 'Maximum core clock speeds. High-density 16th stream.',
  },
  {
    id: 4,
    name: 'VOID PROTOCOL',
    ...
    wave: 'square',
    scaleName: 'wholeish',
    scale: SCALES['wholeish']!,
    root: 50,
    difficulty: 'INSANE',
    stars: 5,
    base: 210,
    density: 'dense16',
    tagline: 'Complete automation transcendence. Only elite human reflexes survive.',
  },
];
